...
__all__ = ["RepLightConv","Rep_HGBlock","HGStem","DFL","C1","C2","C2f","RepC3","ContextGuidedBlock_Down","SPDConv","DySample","CARAFE","HWD","RepBlock","BiFusion","CSPStage","RCSOSA","RepNCSPELAN4"]
...
class RepBlock(nn.Module):
    ...
    '''
    def __init__(self, in_channels, out_channels, n=1, block=RepConv, basic_block=RepConv):
        super().__init__()
...
class RepNCSPELAN4(nn.Module):
    # csp-elan
    def __init__(self, c1, c2, n, c3, c4):  # ch_in, ch_out, number, shortcut, groups, expansion
        super().__init__()
        self.c = c3//2
