...
"""
Train a YOLOv8 model on a custom dataset. Models and datasets download automatically from the latest YOLOv8 release.
...
from yolov8.loss import v8DetectionLoss as ComputeLoss
...
def train(hyp, opt, device, callbacks):
    ...
    # hyp["cls"] *= (imgsz / 640) ** 2 * 3 / nl  # scale to image size and layers
